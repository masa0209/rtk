...
This fork performs **no outbound network communication**. Token-saving statistics are stored locally in SQLite (`~/.local/share/rtk/history.db`) and surfaced via `rtk gain`.
