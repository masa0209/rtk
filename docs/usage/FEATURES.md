...
Ce fork ne realise **aucune communication reseau sortante**. Les statistiques d'economies de tokens sont stockees localement dans une base SQLite (`~/.local/share/rtk/history.db`) et consultables via `rtk gain`.
