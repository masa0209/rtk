...
<p align="center">
  <em>This is a fork of <a href="https://github.com/rtk-ai/rtk">rtk-ai/rtk</a> with telemetry removed.</em>
</p>
...
This fork of RTK performs **no outbound network communication**. All token-saving statistics are stored locally in a SQLite database under `~/.local/share/rtk/history.db` and are surfaced via `rtk gain`. No usage data, hashes, or telemetry pings leave the machine.
